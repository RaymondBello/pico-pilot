...
EXTERNAL_DEP_PATH = f'{PICO_PROJECT}/external_dep'

PICO_SDK_PATH = f'{EXTERNAL_DEP_PATH}/pico_sdk'
CHIBI_OS_PATH = f'{EXTERNAL_DEP_PATH}/chibi-os'

# ========================================
# ===== Point to Target & UF2 file =======
# ========================================
...
process = subprocess.Popen(['make', '-j8'], 
                           stdout=subprocess.PIPE,
                           universal_newlines=True)
while True:
    output = process.stdout.readline()
